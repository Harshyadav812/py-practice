...
class ConditionTask(BaseModel):
    ...
    operator: Literal["<", ">", "==", "!=", ">=", "<="]
    right: Any
    then_do: dict[str, Any] | list[dict[str, Any]] | None = None  # Add this
    else_do: dict[str, Any] | list[dict[str, Any]] | None = None  # Add this
...
class LoopTask(BaseModel):
    ...
    skipIf: ConditionSchema | None = None  # Skip this item if true
    breakIf: ConditionSchema | None = None  # Stop loop if true
